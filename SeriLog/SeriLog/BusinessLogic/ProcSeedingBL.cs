...
namespace SeriLogProject.BusinessLogic
{
    public static class ProcSeedingBL
    {
        ...
        //if this keyword is not used then in program.cs you have to call the class and method like ProcSeedingBL.DbProcedureUpdateExecute(app, env) instead of app.DbProcedureUpdateExecute(env)
        {
